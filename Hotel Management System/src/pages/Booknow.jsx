        ...
        <div className="container my-5">
            <div className="row">
                <div className="col-md-10 mx-auto col-12 card shadow-lg border-0 p-4">
                    ...
                    <div className="row">
                        <div className="col-md-6 col-12">
                            <h6 style={{fontSize:"22px",marginTop:"10px"}} className="font-weight-bolder">Number of days : {daysLeft}</h6>
                        </div>
                        <div className="col-md-6 col-12">
                            <h6 style={{padding:"2px",fontSize:"20px",marginBottom:"20px"}} className="font-weight-bold">Price per day : <span className="badge badge-danger">Rs {price}</span></h6>
                            <h6 style={{fontSize:"20px"}} className="font-weight-bold">Total Price to be paid : <span className="text-primary">Rs {daysLeft*price}</span></h6>
                        </div>
                    </div>
